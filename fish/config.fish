...
# See https://github.com/folke/tokyonight.nvim/blob/main/extras/fish/tokyonight_night.fish
...
set -g fish_color_command $theme_cyan
...
set -g fish_color_param $theme_purple
